import { http } from "msw";import { apiFail, apiSuccess, sleep } from "@/shared/mocks";import { mockMaterialDetails, mockPartDetails, type MockMaterialDetail, type MockPartDetail } from "./data";let materialDetails = [...mockMaterialDetails];
