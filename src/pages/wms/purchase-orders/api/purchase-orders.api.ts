import type { PurchaseOrderListParams } from "@/pages/wms/purchase-orders/model";import { queryClient } from "@/shared/api";type PurchaseOrderListQueryParams = Partial<PurchaseOrderListParams> & {
  warehouseId?: number;
};
