import type { MasterListFilter } from "@/features/master-list";import { Badge } from "@/shared/ui";import type { Column } from "@/shared/ui/Table";import { buildPositionCategoryOptions, formatCurrency, formatHeadcount, getPositionCategoryVariant, getPositionStatusVariant } from "../lib/formatters";export interface PositionRecord {
  positionCode: string;
  positionName: string;
  level: number;
  category: string;
