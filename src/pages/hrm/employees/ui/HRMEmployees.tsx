import { useMemo, useState } from "react";import { useNavigate } from "react-router-dom";import { useFactoryBranchesQuery } from "@/entities/factory";import { useVendorsQuery } from "@/entities/vendor";import { useWmsBrancesQuery } from "@/entities/wms";import { PaginationTableSection, usePaginationTable } from "@/features/table-pagination";import { getWorkspaceLabel as resolveWorkspaceLabel } from "@/shared/constants";import type { Schemas } from "@/shared/model";import { Badge, Button, Card, SearchFilterBar } from "@/shared/ui";import { useUserInfoQuery } from "../api";type UserInfo = Schemas["UserInfoResponse"];
