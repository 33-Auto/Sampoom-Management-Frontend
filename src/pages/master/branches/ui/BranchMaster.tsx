import { useNavigate } from "react-router-dom";import { MasterListLayout, useMasterListControls } from "@/features/master-list";import { useBranchesQuery } from "../api";import type { BranchResponseDTO } from "@/pages/master/branches/model";import { createBranchColumns, createBranchFilters } from "./masterListConfig";import { createKeyRecord } from "@/shared/lib";import { Button } from "@/shared/ui";export const BranchMaster = () => {
