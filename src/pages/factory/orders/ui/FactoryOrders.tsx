...
export const FactoryOrders = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "in_progress":
        return "bg-main-100 text-main-700 border-main-200";
      case "pending":
        return "bg-warning-yellow/10 text-warning-yellow border-warning-yellow/20";
      case "scheduled":
        return "bg-main-200/50 text-main-800 border-main-300";
      case "delayed":
        return "bg-error-red/10 text-error-red border-error-red/20";
      default:
        return "bg-grey-100 text-grey-400 border-grey-200";
    }
  };
  ...
  return (
    <div className="min-h-screen bg-bg-white transition-colors duration-200 dark:bg-bg-black">
      <div className="-1 p-6">
        {/* Header */}
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="mb-1 text-2xl font-bold text-bg-black dark:text-bg-card-white">
                생산 주문 관리
              </h1>
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button variant="default" size="sm">
                <i className="ri-add-line mr-2"></i>새 주문
              </Button>
            </div>
          </div>
        </div>
          ...
          <Card className="border-grey-200 p-4 dark:border-grey-400 dark:bg-bg-card-black">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-bg-black dark:text-bg-card-white">
                  {totalOrders}
                </p>
                <p className="mt-1 text-xs text-main-600">활성 주문</p>
              </div>
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-main-100">
          ...
          <Card className="border-grey-200 p-4 dark:border-grey-400 dark:bg-bg-card-black">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-success-green">이번 주</p>
              </div>
          ...
          <Card className="border-grey-200 p-4 dark:border-grey-400 dark:bg-bg-card-black">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-main-600">생산 라인 가동</p>
              </div>
              <div className="0 flex h-10 w-10 items-center justify-center rounded-lg bg-main-200/5">
          ...
          <Card className="border-grey-200 p-4 dark:border-grey-400 dark:bg-bg-card-black">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-error-red">우선 처리 필요</p>
              </div>
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-error-red/10">
          ...
          <div className="p-4">
            <div className="space-y-4">
              {filteredOrders.map((order) => (
                <div
                  key={order.id}
                  className="rounded-lg border border-grey-200 bg-bg-white p-4 dark:border-grey-400 dark:bg-bg-black"
                >
                  <div className="mb-3 items-start justify-between">
                    <div className="-1">
                      <div className="mb-2 flex items-center space-x-3">
                        <span className="font-semibold text-bg-black dark:text-bg-card-white">
                          {order.id}
                        </span>
                        <span
                      ...
                      <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-3">
                        <div>
                          ...
                          <p className="font-medium text-bg-black dark:text-bg-card-white">
                            {order.customer}
                          </p>
                        </div>
                        <div>
                  ...
                  {order.status === "in_progress" && (
                    <div className="mt-3">
                      <div className="mb-1 flex items-center justify-between text-sm text-grey-400 dark:text-grey-300">
                        <span>진행률</span>
                        <span>
                      ...
                      <div className="h-2 w-full rounded-full bg-grey-200 dark:bg-grey-400">
                        <div
                          className="h-2 rounded-full bg-main-500 transition-all duration-300"
                          style={{
