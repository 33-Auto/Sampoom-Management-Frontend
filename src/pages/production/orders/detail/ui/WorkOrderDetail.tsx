...
import { useNavigate } from "react-router-dom";import { Badge, Button } from "@/shared/ui";interface BOMItem {
  id: string;
  itemCode: string;
  itemName: string;
...
export const WorkOrderDetail = () => {
  ...
  const insufficientMaterials = bomItems.filter(
          ...
          <div className="rounded-lg border bg-white p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-900">
                  {workOrder.requestedQuantity} EA
                </p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-500">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {bomItems.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td className="px-4 py-4 whitespace-nowrap">
                        <div
                          className={`text-sm ${item.availableStock >= item.requiredQuantity ? "text-green-600" : "text-red-600"}`}
                        >
          ...
          <div className="rounded-lg border bg-white p-6 shadow-sm">
            ...
            <div className="space-y-3">
              {productionRecords.map((record) => (
                ...
                >
                  <div className="text-sm font-medium text-gray-900">
                    완료: {record.completedQuantity}EA, 불량:{" "}
                    {record.defectQuantity}EA
                  </div>
