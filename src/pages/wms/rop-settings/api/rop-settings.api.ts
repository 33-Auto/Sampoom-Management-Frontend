import type { RopSettingsListParams } from "@/pages/wms/rop-settings/model";import { queryClient } from "@/shared/api";type RopSettingsListQueryParams = Partial<RopSettingsListParams> & {
  warehouseId?: number;
};
