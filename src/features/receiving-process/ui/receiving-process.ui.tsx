...
// @ts-nocheck
import { zodResolver } from "@hookform/resolvers/zod";import { useEffect } from "react";import { useForm } from "react-hook-form";import { cn, useNotification } from "@/shared/lib";import { Button, Card, InfoBox, Input, Textarea } from "@/shared/ui";import { useReceivingProcessQuery } from "../api/receiving-process.api";import { useReceivingProcessMutation } from "../api/receiving-process.mutation";import { ReceivingProcessSchema } from "../model/receiving-process.contract";import type { PurchaseOrderInfo, ReceivingProcess, ReceivingProcessFormProps } from "../model/receiving-process.types";interface OrderInfoProps {
  label: string;
  info: string;
  isFixed?: boolean;
}
