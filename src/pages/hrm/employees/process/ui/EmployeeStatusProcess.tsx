import { useState } from "react";import { useLocation, useNavigate } from "react-router-dom";import { useUpdateStatusMutation } from "../../api";import { getWorkspaceLabel } from "@/shared/constants";import type { Schemas } from "@/shared/model";import { Button, Card, Select } from "@/shared/ui";type UserInfo = Schemas["UserInfoResponse"];
