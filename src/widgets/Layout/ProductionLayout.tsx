...
import { Outlet } from "react-router-dom";import { BranchSelectBar } from "@/features/branch-select";import { ModuleHeader, NavigationTabs } from "@/widgets/Header";const ProductionLayout: React.FC = () => {
  const headerConfig = {
    moduleTitle: "생산 관리",
