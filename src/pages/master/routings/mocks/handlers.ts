import { http } from "msw";import { apiFail, apiSuccess, sleep } from "@/shared/mocks";import { mockRoutingsMaster } from "./data";// itemCode를 기반으로 기본 품목 정보 생성 (FSD 규칙 준수: 다른 slice 참조 제거)
