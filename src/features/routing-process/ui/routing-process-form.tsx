import { zodResolver } from "@hookform/resolvers/zod";import { useEffect, useState } from "react";import { useFieldArray, useForm } from "react-hook-form";import { usePartCategoryOptions, usePartGroupOptions, usePartSelectOptions } from "@/entities/part";import { useWorkCentersQuery } from "@/pages/master";import type { ProcessStepCreateRequestDTO } from "@/pages/master/routings/model";import { useNotification } from "@/shared/lib";import { Button, Input, Select } from "@/shared/ui";import { useCreateRoutingMutation, useDeleteRoutingMutation, useUpdateRoutingMutation } from "../api/routing-process.api";import { RoutingProcessSchema } from "../model/routing-process.contract";
import type { RoutingProcessFormData } from "../model/routing-process.contract";import type { RoutingProcessFormProps } from "../model/routing-process.types";export function RoutingProcessForm({
  routingId,
  routingData,
  onSuccess,
  onCancel,
