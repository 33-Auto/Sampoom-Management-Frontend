      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <div className="mb-2 flex items-center space-x-3">
            ...
            <span
              className={`rounded-full border px-2 py-1 text-xs font-medium ${getStatusColor(bomData.status)}`}
            >
              {getStatusText(bomData.status)}
            </span>
          </div>
          <p style={{ color: "#7C7C7C" }}>
            자재 명세서(BOM)를 편집합니다. 변경사항은 새로운 버전으로
            관리됩니다.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input value={bomData.id} disabled className="bg-gray-50" />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleBomDataChange("productName", e.target.value)
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleBomDataChange("version", e.target.value)
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      handleBomDataChange("status", e.target.value)
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleBomDataChange("description", e.target.value)
                    }
                  />
                </div>
              </div>
          ...
          <div className="lg:col-span-3">
            ...
            >
              ...
              {/* 액션 버튼 */}
              <div
                className="mt-6 flex justify-end space-x-3 border-t pt-6"
                style={{ borderColor: "#E9EAEC" }}
              >
