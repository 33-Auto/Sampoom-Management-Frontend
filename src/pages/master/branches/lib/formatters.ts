import type { BranchStatus, BranchType } from "@/pages/master/branches/model";import { BRANCH_STATUS, BRANCH_TYPE } from "../model";const TYPE_LABELS: Record<BranchType, string> = {
  WAREHOUSE: "창고",
  FACTORY: "공장",
};
