import { http } from "msw";import { apiFail, apiSuccess, sleep } from "@/shared/mocks";import { mockStockingDetails, type StockingProcessDetail } from "./data";let stockingDetails = [...mockStockingDetails];
