import type { WorkCenterStatus, WorkCenterType } from "@/pages/master/workcenters/model";import { WORK_CENTER_STATUS, WORK_CENTER_TYPE } from "../model";type WorkCenterTypeKey = Exclude<WorkCenterType, undefined>;
