import { useLocation, useNavigate, useParams } from "react-router-dom";import { RopProcessForm } from "@/features/rop-process";import type { RopResDto } from "@/pages/wms/rop-settings/model";import { Button } from "@/shared/ui";export function RopProcess() {
  const { id } = useParams();
