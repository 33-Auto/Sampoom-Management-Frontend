...
export default function MaterialMaster() {
  ...
  const rawMaterials = itemMasterData.filter(i => i.type === 'raw_material').length;
  const components = itemMasterData.filter(i => i.type === 'component').length;
  const finishedGoods = itemMasterData.filter(i => i.type === 'finished_good').length;
  const lowStockItems = itemMasterData.filter(i => i.currentStock <= i.minStock).length;
        ...
        <div className="bg-white rounded-lg border shadow-sm" style={{ borderColor: '#CCCCCC' }}>
          <div className="p-4 border-b" style={{ borderColor: '#CCCCCC' }}>
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold" style={{ color: '#17191B' }}>품목 목록</h2>
          ...
          <div className="p-4">
            <div className="space-y-4">
              {filteredItems.map((item) => {
                ...
                return (
                  <div key={item.code} className="p-4 rounded-lg border" style={{ backgroundColor: '#F5F5F5', borderColor: '#CCCCCC' }}>
                    <div className=" items-start justify-between">
                      <div className=" items-start space-x-3">
                        ...
                        <div className="-1">
                          ...
                          <h3 className="font-medium mb-2" style={{ color: '#17191B' }}>{item.name}</h3>
                          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
                            <div>
                              <p style={{ color: '#7C7C7C' }}>카테고리</p>
                              <p className="font-medium" style={{ color: '#17191B' }}>{item.subCategory}</p>
                            </div>
                            <div>
                              <p style={{ color: '#7C7C7C' }}>단위</p>
                              <p className="font-medium" style={{ color: '#17191B' }}>{item.unit}</p>
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              <p className="font-medium" style={{ color: '#17191B' }}>{item.leadTime}일</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{getProcurementText(selectedItem.procurementType)}</p>
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium">₩{selectedItem.standardCost.toLocaleString()}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {getStockStatus(selectedItem.currentStock, selectedItem.minStock, selectedItem.maxStock).text}
                    </p>
                  </div>
                </div>
              </div>
