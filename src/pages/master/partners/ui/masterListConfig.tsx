import type { MasterListFilter } from "@/features/master-list";import { Badge, Button } from "@/shared/ui";import type { Column } from "@/shared/ui/Table";import { buildPartnerStatusOptions, formatPartnerStatus, getPartnerStatusVariant } from "../lib/formatters";import type { PartnerResponseDTO, PartnerStatus } from "../model";interface PartnerColumnsParams {
