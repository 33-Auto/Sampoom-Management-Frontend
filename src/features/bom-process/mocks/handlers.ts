import { http } from "msw";import { apiFail, apiSuccess, sleep } from "@/shared/mocks";import { mockBomDetails, type MockBomDetail } from "./data";let bomDetails = [...mockBomDetails];
