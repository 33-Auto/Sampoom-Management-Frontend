import type { ProductionPlanBatchResponse, ProductionPlanListParams, ProductionPlanResponseDTO } from "@/pages/production/planning/model";import { DEFAULT_INCLUDE_RECENT_DAYS } from "../model";import { queryClient } from "@/shared/api";export type ProductionPlansQueryParams = ProductionPlanListParams & {
  factoryId?: number;
