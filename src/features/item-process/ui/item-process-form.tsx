import { zodResolver } from "@hookform/resolvers/zod";import { type ReactNode, useEffect } from "react";import { type SubmitHandler, useForm } from "react-hook-form";import { useMaterialCategoryOptions } from "@/entities/material";import { usePartCategoryOptions, usePartGroupOptions } from "@/entities/part";import { queryClient } from "@/shared/api";import { useNotification } from "@/shared/lib";import type { Schemas } from "@/shared/model";import { Button, Input, Select } from "@/shared/ui";import { useCreateMaterialMutation, useCreatePartMutation, useUpdateMaterialMutation, useUpdatePartMutation } from "../api/item-process.api";import { ItemProcessSchema, type ItemProcessFormData, type ItemProcessFormProps, type ItemProcessType, type MaterialCreateRequestDTO, type MaterialDetailResponseDTO, type MaterialUpdateRequestDTO, type PartCreateRequestDTO, type PartUpdateRequestDTO } from "../model";// PartDetailResponseDTO가 PartResponseDTO를 참조하지만 실제 API는 PartListResponseDTO를 반환
