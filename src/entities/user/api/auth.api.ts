import { fetchClient, queryClient } from "@/shared/api";import type { SignupRequest, UserResponse } from "@/shared/model";import type { ApiResponseUserLoginResponse, UserLoginResponse } from "../model";export const useLoginMutation = () =>
