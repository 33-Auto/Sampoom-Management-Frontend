...
export const mockPartCategories: MockPartCategory[] = [
  {
    categoryId: 1,
    categoryName: "엔진 부품",
    name: "엔진 부품", // 레거시 호환성
...
export const mockPartGroups: MockPartGroup[] = [
  {
    groupId: 11,
    categoryId: 1,
    groupName: "연료 공급",
...
export const mockPartItems: MockPartItem[] = [
  {
    id: 1001,
    categoryId: 1,
    groupId: 11,
