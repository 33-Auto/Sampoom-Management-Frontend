import { useLoaderData, useLocation, useNavigate, useParams } from "react-router-dom";import { useBranchId } from "@/features/branch-select";import { StockingProcessForm } from "@/features/stocking-process";
import type { StockingProcessLoaderResult } from "@/features/stocking-process";import { Button } from "@/shared/ui";type LocationState = {
  warehouseId?: number;
};
