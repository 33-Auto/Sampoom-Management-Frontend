import type { SalesOrderDto, SalesOrderListParams, SalesOrderListResponse } from "@/pages/sales/orders/model";import { queryClient } from "@/shared/api";const DEFAULT_PAGE = 0;
