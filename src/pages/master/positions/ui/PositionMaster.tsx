import { MasterListLayout, useMasterListControls } from "@/features/master-list";import { Button } from "@/shared/ui";import { createPositionFilters, positionColumns, type PositionRecord } from "./masterListConfig";export const PositionMaster = () => {
  const {
    searchTerm,
    handleSearchChange,
    filters,
