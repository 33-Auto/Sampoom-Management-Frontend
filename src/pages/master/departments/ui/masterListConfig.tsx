import type { MasterListFilter } from "@/features/master-list";import { Badge } from "@/shared/ui";import type { Column } from "@/shared/ui/Table";import { buildDepartmentStatusOptions, formatDepartmentBudget, formatDepartmentHeadcount, getDepartmentStatusVariant } from "../lib/formatters";interface DepartmentRecord {
  deptCode: string;
  deptName: string;
  parentDept: string;
  manager: string;
