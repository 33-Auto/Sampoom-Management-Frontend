import { PRODUCTION_PLAN_MATERIAL_AVAILABILITY_BADGE_VARIANTS, PRODUCTION_PLAN_MATERIAL_AVAILABILITY_LABELS, PRODUCTION_PLAN_PRIORITY_LABELS, PRODUCTION_PLAN_STATUS_BADGE_VARIANTS, PRODUCTION_PLAN_STATUS_LABELS, type ProductionPlanResponseDTO } from "@/pages/production";import { Badge, Button, Modal } from "@/shared/ui";const formatDate = (value?: string) => {
  if (!value) return "-";
