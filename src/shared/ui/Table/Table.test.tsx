import { render, screen, waitFor } from "@testing-library/react";import { describe, expect, it } from "vitest";// 테스트할 컴포넌트와 타입을 import
import { Table } from "./Table";
import type { Column } from "./Table";// 경로가 올바르다고 가정
