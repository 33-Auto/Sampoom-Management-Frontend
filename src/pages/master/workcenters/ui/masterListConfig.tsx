import type { MasterListFilter } from "@/features/master-list";import { Badge, Button, InfoBox } from "@/shared/ui";import type { Column } from "@/shared/ui/Table";import { buildWorkCenterStatusOptions, buildWorkCenterTypeOptions, formatCostPerHour, formatEfficiency, formatOperatingHours, formatWorkCenterStatus, formatWorkCenterType, getWorkCenterStatusVariant, getWorkCenterTypeBadgeVariant } from "../lib/formatters";import type { WorkCenterResponseDTO, WorkCenterStatus, WorkCenterType } from "../model";interface WorkCenterColumnsParams {
