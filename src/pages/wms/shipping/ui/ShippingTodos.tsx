import { useCallback, useEffect, useMemo, useState } from "react";import { useLoaderData, useLocation, useNavigate } from "react-router-dom";import { usePartCategoryOptions, usePartGroupOptions } from "@/entities/part";import { useBranchId, useBranchSelectionStore } from "@/features/branch-select";import { PaginationTableSection, usePaginationTable } from "@/features/table-pagination";import { type ShippingListQueryParams, useShippingListQuery } from "../api/shipping-list.api";import type { ShippingListParams, ShippingOrderDto, ShippingOrderItemDto } from "@/pages/wms/shipping/model";import { Badge, Button, InfoBox, SearchFilterBar, Table } from "@/shared/ui";type ShippingStatus = NonNullable<ShippingListParams["status"]>;
