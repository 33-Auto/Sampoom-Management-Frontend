import { useEffect, useMemo, useState } from "react";import { useLoaderData } from "react-router-dom";import { useAgencyBranchOptions } from "@/entities/agency";import { useBranchId, useBranchSelectionStore } from "@/features/branch-select";import { Button, SearchFilterBar, Table, TableSection } from "@/shared/ui";import { type SalesOrderListQueryParams, useSalesOrdersQuery } from "../api";import { SALES_ORDER_STATUS_FILTER_OPTIONS, SALES_ORDER_STATUS_LABELS, type SalesOrderDto, type SalesOrderStatus, type SalesOrderStatusFilterValue } from "../model";type SalesOrderRow = {
  orderId: number;
  orderNumber: string;
  createdDate: string;
  agencyName: string;
