import { zodResolver } from "@hookform/resolvers/zod";import { useEffect, useMemo } from "react";import { useFieldArray, useForm } from "react-hook-form";import { formatNumber, useNotification } from "@/shared/lib";import { Button, Card, Input, Table } from "@/shared/ui";import { useShippingProcessMutation } from "../api";import { ShippingProcessSchema, toShippingProcessItems, type ShippingProcessFormData, type ShippingProcessFormInput, type ShippingProcessFormProps } from "../model";export function ShippingProcessForm({
  warehouseId,
  orderId,
  order,
  onSuccess,
