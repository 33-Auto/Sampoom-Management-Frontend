import { useMemo } from "react";import { ROUTING_STATUS } from "./routings.model";
import type { ProcessResponseDTO } from "./routings.model";export const useRoutingStats = (data: ProcessResponseDTO[]) => {
  return useMemo(() => {
