...
import { render, screen } from "@testing-library/react";// userEvent: 실제 사용자가 버튼을 클릭하는 것과 같은 상호작용을 시뮬레이션합니다.
import userEvent from "@testing-library/user-event";
// React는 모든 컴포넌트 테스트에 기본적으로 필요합니다.
import React from "react";
// test, expect, vi: Vitest에서 제공하는 테스트 함수, 단언(assertion) 함수, 모의(mock) 함수입니다.
import { expect, test, vi } from "vitest";// 테스트할 대상인 Button 컴포넌트와, 클래스 검증에 사용할 buttonVariants를 가져옵니다.
import { Button, buttonVariants } from "./Button";// --- TDD 1단계: 가장 기본적인 기능 정의 (Red -> Green) ---
/**
