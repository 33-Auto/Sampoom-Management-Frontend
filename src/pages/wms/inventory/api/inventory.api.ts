import type { InventoryListParams } from "@/pages/wms/inventory/model";import { queryClient } from "@/shared/api";type InventoryListQueryParams = Partial<InventoryListParams> & {
  warehouseId?: number;
};
