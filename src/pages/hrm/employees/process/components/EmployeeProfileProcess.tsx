...
import { useEmployeeProfileMutation } from "@/pages/hrm/employees/api";
import { getWorkspaceLabel } from "@/shared/constants";
...
export function EmployeeProfileProcess() {
  ...
  const updateMutation = useEmployeeProfileMutation();
    ...
    updateMutation.mutate(
      {
        params: {
          ...
          query: { workspace: user.workspace as any },
        },
        body: {
