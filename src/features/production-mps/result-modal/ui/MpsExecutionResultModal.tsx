import type { MpsPlanResult, PartOrderResult } from "@/entities/mps";import { cn } from "@/shared/lib";import { Badge, Button, Modal, Table } from "@/shared/ui";const formatDate = (value?: string | null, withTime = false) => {
  if (!value) return "-";
