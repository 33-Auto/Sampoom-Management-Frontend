import type { z } from "zod";import type { ReceivingProcessResponse } from "@/shared/model";import type { ReceivingProcessSchema } from "./receiving-process.contract";// 모든 type들을 모아둔 것
