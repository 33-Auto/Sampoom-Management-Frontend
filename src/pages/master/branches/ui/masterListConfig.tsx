import type { MasterListFilter } from "@/features/master-list";import { Badge, Button } from "@/shared/ui";import type { Column } from "@/shared/ui/Table";import { buildBranchStatusOptions, buildBranchTypeOptions, formatBranchStatus, formatBranchType, getBranchStatusVariant, getBranchTypeBadgeVariant } from "../lib/formatters";import type { BranchResponseDTO, BranchStatus, BranchType } from "../model";interface BranchColumnsParams {
