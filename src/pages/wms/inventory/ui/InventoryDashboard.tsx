import { useEffect, useMemo, useState } from "react";import { useLoaderData } from "react-router-dom";import { normalizeInventoryStatus } from "@/entities/inventory";import { usePartCategoryOptions, usePartGroupOptions } from "@/entities/part";import { useBranchId, useBranchSelectionStore } from "@/features/branch-select";import { PaginationTableSection, usePaginationTable } from "@/features/table-pagination";import { type InventoryListQueryParams, useWarehouseInventoryQuery } from "../api";import type { InventoryStatusKey, PartResDto } from "@/pages/wms/inventory/model";import { INVENTORY_STATUS_BADGE_VARIANTS, INVENTORY_STATUS_LABELS } from "../model";import { createKeyRecord, formatCurrency, formatNumber } from "@/shared/lib";import { Badge, Button, InfoBox, SearchFilterBar, Table } from "@/shared/ui";export const InventoryDashboard = () => {
