import { http } from "msw";import { apiFail, apiSuccess, sleep } from "@/shared/mocks";import { mockWorkCenters, type WorkCenterRecord } from "./data";let workCenters = [...mockWorkCenters];
