import { useEffect, useMemo, useState } from "react";import { useLoaderData } from "react-router-dom";import { useBranchId, useBranchSelectionStore } from "@/features/branch-select";import { PaginationTableSection, usePaginationTable } from "@/features/table-pagination";import { type PartOrdersQueryParams, usePartOrdersQuery } from "../api";import { DEFAULT_PART_ORDER_STATUSES, PART_ORDER_PRIORITY_BADGE_VARIANTS, PART_ORDER_PRIORITY_LABELS, PART_ORDER_STATUS_BADGE_VARIANTS, PART_ORDER_STATUS_LABELS, type PartOrderPriority, type PartOrderResponseDTO, type PartOrderStatus } from "../model";import { createKeyRecord } from "@/shared/lib";import { Badge, Button, Modal, SearchFilterBar, Table } from "@/shared/ui";export const WorkOrders = () => {
