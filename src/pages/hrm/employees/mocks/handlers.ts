import { http } from "msw";import { apiFail, apiSuccess, sleep } from "@/shared/mocks";import { mockEmployeeRecords, type EmployeeRecord } from "./data";let employeeRecords = [...mockEmployeeRecords];
