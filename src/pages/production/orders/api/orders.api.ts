import type { PartOrderListParams } from "@/pages/production/orders/model";import { DEFAULT_PART_ORDER_STATUSES } from "../model";import { queryClient } from "@/shared/api";export type PartOrdersQueryParams = PartOrderListParams & {
  factoryId?: number;
};
