import { useEffect, useState } from "react";import { usePartCategoryOptions, usePartGroupOptions, usePartSelectOptions } from "@/entities/part";import { useMaterialsQuery } from "@/pages/master";import type { MaterialResponseDTO } from "@/pages/master/bom/model";import { useNotification } from "@/shared/lib";import { Button, Card, Input, Modal, Select } from "@/shared/ui";import { useCreateBomProcessMutation, useDeleteBomProcessMutation, useUpdateBomProcessMutation } from "../api/bom-process.api";import type { BomProcessFormProps } from "../model/bom-process.types";interface BomMaterial {
  materialId: number;
  materialName: string;
  materialCode: string;
  quantity: number;
