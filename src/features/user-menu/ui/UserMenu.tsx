import { useEffect, useRef, useState } from "react";import { useNavigate } from "react-router-dom";import { useAuthStore, useLogoutMutation } from "@/entities/user";import { useNotification } from "@/shared/lib";import type { UserResponse } from "@/shared/model";interface UserMenuProps {
  user: UserResponse;
  profilePath?: string;
  loginPath?: string;
}
