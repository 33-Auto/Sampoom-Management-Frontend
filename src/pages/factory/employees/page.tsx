...
export default function FactoryEmployees() {
  ...
  const getDepartmentText = (department: string) => {
    switch (department) {
      case 'production': return '생산부';
      case 'quality': return '품질관리부';
      case 'safety': return '안전관리부';
      case 'maintenance': return '설비보전부';
      case 'logistics': return '자재관리부';
  ...
  const navItems = [
    ...
    { path: '/factory/employees', label: '직원 관리', icon: 'ri-team-line', active: true }
  ];
