import { http } from "msw";import { apiFail, apiSuccess, sleep } from "@/shared/mocks";import { mockSalesOrders, mockSalesOrdersDto } from "./data";// warehouseId로 필터링 (레거시 데이터 사용)
